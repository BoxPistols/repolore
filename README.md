...
**Status:** Alpha. Phases 1–2 are implemented: three viewpoints (`architecture`, `deps`, `git-history`), Mermaid output, TypeScript/JavaScript repos. Multi-format renderers, LLM curation, and Python/Go analyzers are on the roadmap below.
...
- **Phase 2** *(current)* ✅ — `deps` + `git-history` viewpoints
